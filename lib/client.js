...
// src/client/codexAccounts.ts
var initialState = Object.freeze({ status: "idle", accounts: [], error: null });
...
var CodexAccountsController = class {
  ...
  async select(id) {
    ...
    if (current.switchingId !== void 0) throw new Error("Another account switch is still running");
      ...
      children: [
        ...
        open === "provider" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${ModelPanel_default.menu} ${ModelPanel_default.providerMenu}`, role: "dialog", "aria-label": t("providerTitle"), "aria-busy": fetching, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: ModelPanel_default.head, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: ModelPanel_default.reload, disabled: pending || fetching, onClick: () => {
              reload();
              void loadAccounts();
            }, children: t("reload") })
          ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: ModelPanel_default.providerList, role: "listbox", "aria-label": t("providerTitle"), children: directory.groups.map((candidate) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "button",
                  {
                    ...
                    className: selected ? `${ModelPanel_default.providerOption} ${ModelPanel_default.providerCurrent}` : ModelPanel_default.providerOption,
                    disabled: pending,
                    onClick: () => {
                ...
                isCodexProvider(candidate.id) && accounts.status === "error" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: ModelPanel_default.accountNote, children: t("accountLoadFailed", { message: accounts.error ?? t("accountUnavailable") }) }) : isCodexProvider(candidate.id) && (accounts.status === "idle" || accounts.status === "loading") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: ModelPanel_default.accountNote, children: t("accountsLoading") }) : null
              ] }, candidate.id);
            }
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: ModelPanel_default.providerFamily, role: "group", "aria-label": candidate.name, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: ModelPanel_default.providerFamilyHead, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: candidate.name }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: ModelPanel_default.providerCount, children: t("accountCount", { count: accounts.accounts.length }) })
              ] }),
              accountError === null ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: ModelPanel_default.accountError, role: "alert", children: t("accountSwitchFailed", { message: accountError }) }),
              accounts.accounts.map((account) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                  "button",
                  {
                    ...
                    className: selected && account.active ? `${ModelPanel_default.accountOption} ${ModelPanel_default.providerCurrent}` : ModelPanel_default.accountOption,
                    disabled: pending,
                    onClick: () => {
                      chooseAccount(candidate.id, account.id, account.active);
                    },
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: ModelPanel_default.accountIdentity, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: ModelPanel_default.accountLabel, children: account.label }),
                        email === void 0 ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: ModelPanel_default.accountEmail, children: email })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: ModelPanel_default.accountState, children: accounts.switchingId === account.id ? t("accountSwitching") : account.active ? t("accountActive") : t("accountUse") })
                    ]
                  },
                  account.id
                );
...
function apply(ctx) {
  ...
  }, "dsh-model-panel: Codex account controller");
  ctx.effect(() => ctx.on("connection/reset", () => {
    codexAccounts.invalidate();
  }), "dsh-model-panel: Codex account reset");
  ctx.effect(() => {
