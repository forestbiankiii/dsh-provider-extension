...
var CodexAccountsController = class {
  ...
  async login() {
    ...
    try {
      ...
      const startResult = await call(this.rpc, "login/start", { openExternal: true, label: `Account ${nextIndex}` });
  ...
  async removeAccount(id) {
    ...
    try {
      ...
      const latest = this.store.getSnapshot();
      this.store.set(Object.freeze({ ...latest, switchingId: void 0, error: failureMessage(error) }));
      throw error;
    }
  }
...
function decodeAccounts(value) {
  ...
  for (const raw of root.accounts) {
    ...
    accounts.push(Object.freeze({
      id: acc.id,
      label: typeof acc.label === "string" ? acc.label : acc.email || "Google Account",
...
function getDisabledModelsForAccount(accountId) {
...
function ProviderPanel({
  ...
  const disabledForCurrent = isAntigravityProvider(group?.id) ? getDisabledModelsForAccount(activeAgAccount?.id) : disabledModels;
  ...
  const codexWeekly = codexUsage?.status === "ready" ? codexUsage.value.weeklyPercent : void 0;
  ...
  ] }) : isCodex && codexWeekly !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: ProviderPanel_default.quotaWrapper, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
        type: "button",
        ...
        children: t("weeklyQuota", { value: codexWeekly })
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: ProviderPanel_default.quotaTooltip, role: "tooltip", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: ProviderPanel_default.quotaTooltipRow, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: ProviderPanel_default.quotaTooltipName, children: "周额度:" }),
...
function formatResetSeconds(epochSeconds) {
  if (!epochSeconds) return "";
  try {
    const diffMs = epochSeconds * 1e3 - Date.now();
    if (diffMs <= 0) return "即将重置";
    const totalMinutes = Math.floor(diffMs / 6e4);
    const days = Math.floor(totalMinutes / (24 * 60));
    const hours = Math.floor(totalMinutes % (24 * 60) / 60);
...
function ProviderSettings({
  ...
  (0, import_react2.useEffect)(() => {
    if (selectedProvider === "codex" || expanded.codex) {
      for (const acc of accounts.accounts) {
        if (!acc.active && accounts.usage[acc.id] === void 0 && accounts.switchingId === void 0) {
  ...
  const toggleAccountModel = (accountId, modelId) => {
  ...
  (0, import_react2.useEffect)(() => {
    if (agAccounts.length === 1 && agAccounts[0] && expandedQuotaAccounts[agAccounts[0].id] === void 0) {
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.accountCardTop, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.accountIdentityCol, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.accountTitleRow, children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.accountTierBadge, "data-tier": "Pro", children: usage?.status === "loading" ? t("quotaReading") : usage?.status === "error" ? t("quotaFailedShort") : weekly === void 0 ? t("quotaNoWeekly") : t("weeklyQuota", { value: weekly }) })
                    ] }),
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.actions, onClick: (e) => e.stopPropagation(), children: [
                    account.active ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.modelState, "data-state": "live-available", children: t("accountActive") }) : selectCodexAccount ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                      "button",
                      {
                        type: "button",
                ...
                isQuotaOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.accountExpandQuota, onClick: (e) => e.stopPropagation(), children: [
                  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: ProviderSettings_default.quotaBlockTitle, children: t("quotaBalance") }),
                  usage?.status === "loading" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: ProviderSettings_default.note, children: t("quotaReading") }) : usage?.status === "ready" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaBars, children: [
                    usage.value.shortPercent !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaBarItem, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaBarHeader, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "5小时额度" }),
                        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: ProviderSettings_default.quotaBarPercent, children: [
                          usage.value.shortPercent,
                          "%"
                        ] })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: ProviderSettings_default.quotaProgressTrack, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                        "div",
                        {
                          className: ProviderSettings_default.quotaProgressFill,
                          style: {
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaBarItem, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaBarHeader, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "周额度" }),
                        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: ProviderSettings_default.quotaBarPercent, children: [
                          usage.value.weeklyPercent ?? 100,
                          "%"
                        ] })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: ProviderSettings_default.quotaProgressTrack, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                      ...
                      usage.value.weeklyResetsAt ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.quotaResetTime, children: formatResetSeconds(usage.value.weeklyResetsAt) }) : null
                    ] })
                  ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.quotaErrorRow, children: [
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.note, children: usage?.status === "error" ? t("quotaFailedShort") : t("quotaNoData") }),
                    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                      "button",
                      {
                        type: "button",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: ProviderSettings_default.page, "data-testid": "provider-settings", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerList, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("article", { className: ProviderSettings_default.providerCard, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerCardHead, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerMain, onClick: () => toggleExpand("gemini"), children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: ProviderSettings_default.providerIcon, "data-provider": "gemini", children: "GM" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerTitles, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.providerTitle, children: t("providerGemini") }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.providerSubtitle, children: t("providerGeminiDesc") })
          ] })
        ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("article", { className: ProviderSettings_default.providerCard, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerCardHead, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerMain, onClick: () => toggleExpand("openai"), children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: ProviderSettings_default.providerIcon, "data-provider": "openai", children: "OA" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerTitles, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.providerTitle, children: t("providerOpenAi") }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.providerSubtitle, children: t("providerOpenAiDesc") })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: ProviderSettings_default.providerRight, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: ProviderSettings_default.providerBadge, "data-status": "roadmap", children: t("providerStatusRoadmap") }),
