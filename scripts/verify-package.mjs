...
if (manifest.name !== 'dsh-model-panel') throw new Error('Unexpected package name')
...
const publicArtifacts = await Promise.all([
  ...
  'lib/types/index.d.ts', 'lib/types/client/index.d.ts', 'lib/types/client/ModelPanel.d.ts',
...
if (!client.startsWith('window.__ModuleLoader__.load({id:"dsh-model-panel"')) {
