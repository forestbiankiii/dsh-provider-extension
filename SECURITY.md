...
- optionally reads the secret-free account roster exposed by `dsh-codex-subscription` 2.x and sends an opaque account id to its authenticated `account/select` endpoint after an explicit click;
