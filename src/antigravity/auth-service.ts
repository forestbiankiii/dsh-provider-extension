...
export class AntigravityAuthService implements BootstrapStatusService {
  ...
  async accounts(): Promise<readonly AntigravityAccountView[]> {
  ...
  async selectAccount(id: string): Promise<readonly AntigravityAccountView[]> {
    if (this.disposed) throw new OAuthFlowError('internal', 'The Antigravity login is unavailable')
  ...
  async updateAccount(id: string, patch: { label?: string | undefined; tier?: string | undefined }): Promise<readonly AntigravityAccountView[]> {
    if (this.disposed) throw new OAuthFlowError('internal', 'The Antigravity login is unavailable')
  ...
  async renameAccount(id: string, label: string): Promise<readonly AntigravityAccountView[]> {
    if (this.disposed) throw new OAuthFlowError('internal', 'The Antigravity login is unavailable')
  ...
  async removeAccount(id: string): Promise<readonly AntigravityAccountView[]> {
    if (this.disposed) throw new OAuthFlowError('internal', 'The Antigravity login is unavailable')
